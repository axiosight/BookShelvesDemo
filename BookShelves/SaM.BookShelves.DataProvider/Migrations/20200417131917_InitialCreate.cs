        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalName = table.Column<string>(maxLength: 250, nullable: true),
                    Description = table.Column<string>(maxLength: 2000, nullable: false),
                    Year = table.Column<int>(maxLength: 2021, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Floor = table.Column<int>(maxLength: 20, nullable: false),
                    Room = table.Column<int>(maxLength: 1000, nullable: false),
                    OfficeId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookEntities_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookEntities_Libraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookEntities_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookEntities_BookId",
                table: "BookEntities",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookEntities_LibraryId",
                table: "BookEntities",
                column: "LibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_BookEntities_StatusId",
                table: "BookEntities",
                column: "StatusId");
